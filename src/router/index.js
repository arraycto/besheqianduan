...
export const asyncRoutes = [
  ...
  // },
  {
    path: '/xieweihao',
    component: Layout,
    redirect: '/xieweihao/Document_information_extraction',
    alwaysShow: true,
    name: 'xieweihao',
    meta: { title: 'xieweihao', icon: 'theme' },
    children: [
      {
        path: 'Document_information_extraction',
        component: () => import('@/views/xieweihao/index'),
        name: 'Document_information_extraction',
        meta: { title: '文献信息提取', icon: 'theme' }
      },
      {
        path: 'Expert_input',
        component: () => import('@/views/xieweihao/ExpertInput'),
        name: 'Expert_input',
      ...
      },
      {
        ...
        component: () => import('@/views/xieweihao/paper'),
        name: 'Paper',
        meta: { title: '文本展示', icon: 'theme' },
        hidden: true
      },
      {
